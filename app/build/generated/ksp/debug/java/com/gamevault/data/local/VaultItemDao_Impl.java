  ...
  public VaultItemDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfVaultItemEntity = new EntityInsertionAdapter<VaultItemEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `vault_items` (`id`,`name`,`type`,`path`,`size`,`dateAdded`,`thumbnailPath`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public List<VaultItemEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new VaultItemEntity(_tmpId,_tmpName,_tmpType,_tmpPath,_tmpSize,_tmpDateAdded,_tmpThumbnailPath);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public VaultItemEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new VaultItemEntity(_tmpId,_tmpName,_tmpType,_tmpPath,_tmpSize,_tmpDateAdded,_tmpThumbnailPath);
          } else {
            _result = null;
          }
          return _result;
